  ...
  return ( 
    <div className="flex max-w-5xl mx-auto flex-col items-center justify-center py-2 min-h-screen">
      ...
      <a
          ...
          href="https://github.com/JeremyTsangchina/xhs"
          target="_blank"
        ...
        <h1 className="sm:text-6xl text-4xl max-w-2xl font-bold text-slate-900">
          ...
          <div className=" px-4 py-2 sm:mt-3 mt-8 hover:bg-black/80 w-full">
          ...
          <div className="mt-1 items-center space-x-3">
            <span className="text-slate-200">
              ...
              <a
                ...
                href="https://github.com/JeremyTsangchina/xhs/blob/main/privacy.md"
                target="_blank"
                rel="noopener noreferrer"
              >{' '}{t('privacyPolicy2')}</a>
            </span>
